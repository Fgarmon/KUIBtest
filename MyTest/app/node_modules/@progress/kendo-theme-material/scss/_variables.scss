...
$button-inner-calc-size: #{$button-line-height * 1em} + #{$button-padding-y * 2};
$button-calc-size: #{$button-inner-calc-size} + #{$button-border-width * 2};
...
$input-inner-calc-size: #{$input-line-height * 1em} + #{$input-padding-y * 2};
$input-calc-size: #{input-inner-calc-size} + 2px;

$textarea-padding-x: 10px !default;
$textarea-padding-y: 15px !default;
$textarea-floating-label-padding: 25px !default;


// Pickers
$picker-button-border-width: 0 !default;
$picker-button-padding-x: ($button-padding-y / 2) !default;
$picker-button-padding-y: $button-padding-y !default;
...
$popup-shadow: 0 3px 3px -2px rgba(0, 0, 0, .02), 0 3px 4px 0 rgba(0, 0, 0, .14), 0 1px 8px 0 rgba(0, 0, 0, .12) !default;
...
// Action buttons
$action-button-text: rgba( $accent, .87 ) !default;
$action-button-hovered-bg: rgba( $accent, .12 ) !default;
$action-button-pressed-bg: rgba( $accent, .16 ) !default;
$action-button-cancel-bg: rgba( black, .12 ) !default;

// Toolbar
$toolbar-text: $button-text !default;
$toolbar-bg: darken($button-bg, 4) !default;
$toolbar-border: $toolbar-bg !default;
$toolbar-gradient: null !default;

// Icon
$icon-opacity: .54;
$icon-hovered-opacity: .87;
$icon-focused-opacity: .87;

// Input
$input-text: $panel-text !default;
$input-bg: $panel-bg !default;
$input-border: rgba( black, .42 ) !default;
$input-shadow: null !default;

$input-hovered-text: $input-text !default;
$input-hovered-bg: $input-bg !default;
$input-hovered-border: rgba( black, .87 ) !default;
...
$grid-toolbar-button-spacing: 8px !default;
...
$grid-border: rgba( black, .12 ) !default;

$grid-header-bg: $header-bg !default;
$grid-header-text: rgba(0, 0, 0, .54) !default;
...
$grid-alt-border: $grid-border !default;
...
$link-hover-text: desaturate(darken($secondary, 5), 25) !default;
...
$card-bg: $panel-bg !default;
$card-text: $panel-text !default;
$card-border: $panel-border !default;
...
$card-header-bg: false !default;
$card-header-text: false !default;
$card-header-border: false !default;
...
$card-actions-border-width: 0 !default;
...
$chat-bg: #f5f5f5 !default;
$chat-text: $panel-text !default;
$chat-border: $panel-border !default;

$chat-bubble-bg: $panel-bg !default;
$chat-bubble-text: $panel-text !default;
...
// Mediaplayer
$mediaplayer-bg: $panel-bg !default;
$mediaplayer-text: $panel-text !default;
$mediaplayer-border: $panel-border !default;

$mediaplayer-titlebar-padding-x: $header-padding-x !default;
$mediaplayer-titlebar-padding-y: $header-padding-y !default;
$mediaplayer-titlebar-bg: false !default;
$mediaplayer-titlebar-text: $mediaplayer-bg !default;
$mediaplayer-titlebar-border: false !default;
...
$progressbar-bg: color-level( $accent, 9 ) !default;
$progressbar-text: $text-color !default;
$progressbar-border: transparent !default;
$progressbar-gradient: false !default;

$progressbar-fill-bg:  $accent !default;
$progressbar-fill-text: $progressbar-text !default;
$progressbar-fill-border: transparent !default;
$progressbar-fill-gradient: false !default;
...
$progressbar-indeterminate-gradient: false !default;
