...
$button-calc-size: #{$button-inner-calc-size} + 2px;
...
$input-line-height-sm: $input-line-height-sm !default;
...
// Pickers
$picker-button-border-width: 1px !default;
$picker-button-padding-x: $button-padding-y !default;
...
$toolbar-button-border-radius: $button-border-radius !default;
...
$toolbar-button-calc-size: #{$toolbar-button-line-height * 1em} + #{$toolbar-button-padding-y * 2} + #{$toolbar-button-border-width * 2};
...
$grid-toolbar-padding-x: ($grid-padding-y / 2) !default;
$grid-toolbar-padding-y: $grid-toolbar-padding-x !default;
$grid-toolbar-button-spacing: $grid-toolbar-padding-y !default;
...
$grid-sorting-indicator-text: $accent !default;

$grid-focused-shadow: inset 0 0 0 2px rgba( 0, 0, 0, .08) !default;
...
$progressbar-fill-bg:  $progress-bar-bg !default;
$progressbar-fill-text: $progress-bar-color !default;
