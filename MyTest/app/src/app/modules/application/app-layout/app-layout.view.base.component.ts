...
export class AppLayoutViewBaseComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public $navigationData = [
        {
            title: 'customer',
            titleKey: 'modules.customer.label',
            thumbnail: {
                background: '#00a2e8',
                color: '#ffffff',
                icon: 'fa-area-chart',
            ...
            children: [
                {
                    title: 'custGrid',
                    titleKey: 'modules.customer.views.custGrid.label',
                    label: 'Customer Grid',
                    routerLink: '/customer/cust-grid',
                    authorization: {
                        allowedRoles: [],
                    },
                },
        ...
        {
            title: 'RestTest',
            titleKey: 'modules.RestTest.label',
            thumbnail: {
                background: '#00a2e8',
                color: '#ffffff',
                icon: 'fa-area-chart',
            ...
            children: [
                {
                    title: 'userGrid',
                    titleKey: 'modules.RestTest.views.userGrid.label',
                    label: 'Users',
                    routerLink: '/rest-test/user-grid',
                    authorization: {
                        allowedRoles: [],
                    },
                },
    ...
    private filterNavigationData(): void {
        this.$navigationData.forEach(module => {
            const views = module.children.filter(view => this.$authorizationService.isAuthorized(view.authorization));
