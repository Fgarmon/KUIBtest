...
import { CustGridViewBaseComponent } from './cust-grid.view.base.component';
...
export const config: NgModule = {
    declarations: [CustGridViewBaseComponent, CustGridViewComponent, BottomSectionComponent, MiddleSectionComponent, TopSectionComponent],
    entryComponents: [],
